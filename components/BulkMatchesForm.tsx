...
// preview → opgeslagen. Losgetrokken van app/events/bulk/page.tsx
// (validatiebevinding 2, brief §4.5): die pagina is nu een server component
// die eerst canEdit(ctx,'agenda') afdwingt en dit formulier alleen rendert
// mét dat recht — dit bestand blijft zelf ONgated, puur UI, zodat
// wedstrijden-bulk-toevoegen.acceptance.test.tsx het rechtstreeks kan blijven
// renderen zonder een teamcontext na te bouwen.
//
// Opgezet als components/NewEventForm.tsx: zelfde BackButton/container/
// foutkader-stijl. De feitelijke rij-state en afgeleide validatie/duplicaten
// zitten in useBulkMatchRows (lib/use-bulk-match-rows.ts); dit bestand
// koppelt dat aan de server actions.
...
export default function BulkMatchesForm() {
  const t = useDict()
